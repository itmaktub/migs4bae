		...
		<nav id="x-login" role="navigation">
			<ul id="x-login-nav">
				...
				<li><a href="<?php echo SITE_URL;?>">首页</a></li>
				 <?php
                $category = $migs_db->get_results("SELECT * FROM mi_category ORDER BY orderby ASC");
                foreach($category as $single){ ?>
              <li><a href="<?php echo SITE_URL."gallery/$single->id";?>" title="<?php echo $single->desc;?>"><?php echo $single->cate_name?></a></li>
                <?php }?>
